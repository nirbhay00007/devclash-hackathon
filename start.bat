...
echo  [2/3] Starting Node.js ML Backend on port 3001...
start "DEV_CLASH - Node ML Backend" cmd /k "cd backend && npm start"

REM ── 3. Unified Frontend (Vite) ────────────────────────────────────────────────
echo  [3/3] Starting Unified Frontend on port 5173...
start "DEV_CLASH - Frontend" cmd /k "cd frontend_merged && npm run dev"
